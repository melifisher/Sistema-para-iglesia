...
<head>
	...
	<title>Lista de Bautismos</title>
	...
	<main class="full-box main-container">
		...
		<section class="full-box page-content">
			...
			<div class="full-box page-header">
				<h3 class="text-left">
					<i class="fas fa-sync-alt fa-fw"></i> &nbsp; ACTUALIZAR BAUTISMO
				</h3>
			</div>
			...
			$nro = $_GET['nro'];
			$bautismo = $nBautismo->obtenerPorNro($nro);
			?>
			<!-- Content here-->
			<div class="container-fluid">
								...
								<div class="col-12 col-md-6">
									<div class="form-group">
										...
										<input type="text" pattern="[a-zA-Z0-9-]{1,27}" class="form-control" name="nro"
											id="nro" maxlength="27" value="<?php echo $bautismo->nro; ?>" readonly>
									</div>
								</div>
								<div class="col-12 col-md-6">
									<div class="form-group">
										...
										<select name="id_bautizado" id="id_bautizado" required>
											...
											<?php foreach ($personas as $persona) { ?>
												<option value="<?php echo $persona->id ?>" <?php if($persona->id == $bautismo->id_bautizado) echo 'selected' ?> >
								...
								<div class="col-12 col-md-6">
									<div class="form-group">
										...
										<input type="text"class="form-control" name="lugar"
											id="lugar" value="<?php echo $bautismo->lugar; ?>" >
									</div>
								</div>
								<div class="col-12 col-md-6">
									<div class="form-group">
										...
										<input type="text"class="form-control" name="fecha_celebracion"
											id="fecha_celebracion" placeholder="yyyy-mm-dd" value="<?php echo $bautismo->fecha_celebracion; ?>">
									</div>
								</div>
								<div class="col-12 col-md-6">
									<div class="form-group">
										...
										<input type="text"class="form-control" name="fecha_registro"
											id="fecha_registro" value="<?php echo $bautismo->fecha_registro; ?>" readonly >
									</div>
								</div>
								<div class="col-12 col-md-6">
									<div class="form-group">
										...
										<select name="id_parroco" id="id_parroco" required>
											...
											<?php foreach ($personas as $persona) { 
												...
												<option value="<?php echo $persona->id ?>" <?php if($persona->id == $bautismo->id_parroco) echo 'selected' ?> >
													<?php echo $persona->nombre. " ". $persona->apellidos ?>
												</option>
											<?php }
											} ?>
								...
								<div class="col-12 col-md-6">
									<div class="form-group">
										...
										<input type="text"class="form-control" name="padrinos"
											id="padrinos" value="<?php echo $bautismo->padrinos; ?>">
									</div>
								</div>
							</div>
						</div>
