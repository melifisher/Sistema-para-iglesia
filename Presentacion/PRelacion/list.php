...
<head>
	...
	<title>Lista de Relacions</title>
	...
	<main class="full-box main-container">
		...
		<section class="full-box page-content">
			...
			<div class="full-box page-header">
				<h3 class="text-left">
					<i class="fas fa-clipboard-list fa-fw"></i> &nbsp; LISTA DE RELACIONES
				</h3>
			</div>
			...
			<div class="container-fluid">
				<ul class="full-box list-unstyled page-nav-tabs">
					...
					<li>
						<a class="active" href="#"><i class="fas fa-clipboard-list fa-fw"></i> &nbsp; LISTA DE RELACIONES</a>
					</li>
					<li>
				...
				<div class="table-responsive">
					<table class="table table-dark table-sm">
						...
						<tbody>
							...
							$nTipo = new NTipo();
							$relacions = $nRelacion->lista();
							foreach ($relacions as $relacion) {
								?>
								<tr class="text-center">
									<td>
										<?php $persona1 = $nPersona->obtenerPorId($relacion->id_persona1);
										echo $persona1->nombre . ' ' . $persona1->apellidos ?>
									</td>
									<td>
										<?php $persona2 = $nPersona->obtenerPorId($relacion->id_persona2);
										echo $persona2->nombre . ' ' . $persona2->apellidos ?>
									</td>
									<td>
										<?php echo $nTipo->obtenerPorId($relacion->id_tipo)->nombre ?>
									</td>
									<td>
										<a href="update.php?id_1=<?php echo $relacion->id_persona1 ?>&id_2=<?php echo $relacion->id_persona2 ?>"
									...
									<td>
										<form action="delete.php" method="POST">
											<input type="hidden" name="id_persona1"
												value="<?php echo $relacion->id_persona1; ?>" />
											<input type="hidden" name="id_persona2"
												value="<?php echo $relacion->id_persona2; ?>" />
