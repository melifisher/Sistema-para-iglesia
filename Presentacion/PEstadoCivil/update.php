	...
	<main class="full-box main-container">
		...
		<section class="full-box page-content">
			...
			<div class="full-box page-header">
				<h3 class="text-left">
					<i class="fas fa-sync-alt fa-fw"></i> &nbsp; ACTUALIZAR ESTADO CIVIL
				</h3>
			</div>
			...
			<div class="container-fluid">
				<ul class="full-box list-unstyled page-nav-tabs">
					...
					<li>
						<a href="list.php"><i class="fas fa-clipboard-list fa-fw"></i> &nbsp; LISTA DE ESTADO
							CIVILS</a>
					</li>
					<li>
			...
			$id = $_GET['id'];
			$estadoCivil = $nEstadoCivil->obtenerPorId($id);
								...
								<div class="col-12 col-md-6">
									<div class="form-group">
										...
										<input type="text" pattern="[a-zA-Z0-9-]{1,27}" class="form-control" name="id"
											id="id" maxlength="27" value="<?php echo $estadoCivil->id; ?>" readonly>
									</div>
								</div>
								<div class="col-12 col-md-6">
									<div class="form-group">
										...
										<input type="text" pattern="[a-zA-ZáéíóúÁÉÍÓÚñÑ ]{1,40}" class="form-control"
											...
											value="<?php echo $estadoCivil->nombre; ?>">
									</div>
								</div>
							</div>
						</div>
