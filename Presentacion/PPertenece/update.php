...
<head>
	...
	<title>Lista de Pertenecees</title>
	...
	<main class="full-box main-container">
		...
		<section class="full-box page-content">
			...
			<div class="full-box page-header">
				<h3 class="text-left">
					<i class="fas fa-sync-alt fa-fw"></i> &nbsp; ACTUALIZAR PERTENENCIA A MINISTERIO
				</h3>
			</div>
			...
			<div class="container-fluid">
				<ul class="full-box list-unstyled page-nav-tabs">
					<li>
						<a href="new.php"><i class="fas fa-plus fa-fw"></i> &nbsp; AGREGAR PERTENENCIA A MINISTERIO</a>
					</li>
					<li>
						<a href="list.php"><i class="fas fa-clipboard-list fa-fw"></i> &nbsp; LISTA DE PERTENENCIA A MINISTERIOS</a>
					</li>
					<li>
						<a href="search.php"><i class="fas fa-search fa-fw"></i> &nbsp; BUSCAR PERTENENCIA A MINISTERIO</a>
					</li>
				</ul>
			</div>
			...
			$id_1 = $_GET['id_1'];
			$id_2 = $_GET['id_2'];
			$pertenece = $nPertenece->obtenerPorId($id_1, $id_2);
			?>
			<!-- Content here-->
			<div class="container-fluid">
					...
					<fieldset>
						...
						<div class="container-fluid">
							<div class="row">
								...
								$persona=$nPersona->obtenerPorId($id_1);?>
								<div class="col-12 col-md-6">
									<div class="form-group">
										<label for="id_persona" class="bmd-label-floating">Persona</label>
										<input type="text" class="form-control" id="id_persona" value="<?php echo $persona->nombre.' '.$persona->apellidos?>" readonly>
										<input type="hidden" class="form-control" name="id_persona" value="<?php echo $id_1?>" >
									</div>
								</div>
								<div class="col-12 col-md-6">
									<div class="form-group">
										<label for="id_ministerio" class="bmd-label-floating">Ministerio</label>
										<?php $nMinisterio=new NMinisterio();
											$ministerio=$nMinisterio->obtenerPorId($id_2);
										?>
										<input type="text" class="form-control" id="id_ministerio" value="<?php echo $ministerio->nombre ?>" readonly>
										<input type="hidden" class="form-control" name="id_ministerio" value="<?php echo $id_2?>" >
									</div>
								</div>
								<div class="col-12 col-md-6">
									<div class="form-group">
										<label for="detalle" class="bmd-label-floating">Detalle</label>
										<input type="text" class="form-control" name="detalle" id="detalle" value="<?php echo $pertenece->detalle?>" required>
									</div>
								</div>
							</div>
						</div>
