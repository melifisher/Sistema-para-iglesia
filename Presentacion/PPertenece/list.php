...
<head>
	...
	<title>Lista de Perteneces</title>
	...
	<main class="full-box main-container">
		...
		<section class="full-box page-content">
			...
			<div class="full-box page-header">
				<h3 class="text-left">
					<i class="fas fa-clipboard-list fa-fw"></i> &nbsp; LISTA DE PERTENENCIA A MINISTERIOS
				</h3>
			</div>
			...
			<div class="container-fluid">
				<ul class="full-box list-unstyled page-nav-tabs">
					...
					<li>
						<a class="active" href="#"><i class="fas fa-clipboard-list fa-fw"></i> &nbsp; LISTA DE PERTENENCIA A MINISTERIOS</a>
					</li>
					<li>
				...
				<div class="table-responsive">
					<table class="table table-dark table-sm">
						...
						<tbody>
							...
							$perteneces = $nPertenece->lista();
							foreach ($perteneces as $pertenece) {
								?>
								<tr class="text-center">
									<td>
										<?php $persona = $nPersona->obtenerPorId($pertenece->id_persona);
										echo $persona->nombre . ' ' . $persona->apellidos ?>
									</td>
									<td>
										<?php 
										echo $nMinisterio->obtenerPorId($pertenece->id_ministerio)->nombre ?>
									</td>
									<td>
										<?php echo $pertenece->detalle ?>
									</td>
									<td>
										<a href="update.php?id_1=<?php echo $pertenece->id_persona ?>&id_2=<?php echo $pertenece->id_ministerio ?>"
									...
									<td>
										<form action="delete.php" method="POST">
											<input type="hidden" name="id_persona"
												value="<?php echo $pertenece->id_persona ?>" />
											<input type="hidden" name="id_ministerio"
												value="<?php echo $pertenece->id_ministerio ?>" />
